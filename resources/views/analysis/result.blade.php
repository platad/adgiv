                                ...
                                <div class="flex flex-col md:flex-row gap-4 md:gap-8">
                                    ...
                                    <div class="flex-grow">
                                        <p
                                            ...
                                            <span class="flex flex-col gap-2 w-full mt-2 select-none">
                                                {{-- Pola Bimbingan Box --}}
                                                <span class="w-full flex flex-wrap items-center gap-2 p-2.5 border border-dashed border-gray-300 bg-gray-50/60 rounded-2xl">
                                                ...
                                                <span class="w-full flex flex-wrap items-center gap-2 p-2.5 border border-dashed border-purple-200 bg-purple-50/30 rounded-2xl">
