...
<div class="space-y-6 lg:space-y-8 relative pt-4">
    {{-- Vertical Line Connector --}}
    <div class="absolute left-[19px] lg:left-[23px] top-10 bottom-10 w-0.5 bg-gray-100"></div>

    {{-- Step 1: Analisa Suara --}}
    <div class="relative flex items-start gap-3 lg:gap-4 group">
        <div class="relative z-10">
            <div class="w-10 h-10 lg:w-12 lg:h-12 rounded-full flex items-center justify-center transition-all duration-500 shadow-lg border-4 border-white"
                ...
                <i data-lucide="mic" class="w-4 h-4 lg:w-5 lg:h-5"></i>
            </div>
        </div>
        <div class="flex-1 pt-0.5 lg:pt-1">
            <h4 class="text-[0.7rem] lg:text-xs font-black uppercase tracking-widest" 
                :class="activeStep === 1 ? 'text-bima-red' : (session.raw_transcription !== '-' ? 'text-gray-900' : 'text-gray-400')">
                Step 1: Analisa Suara
            </h4>
            <p class="text-[0.65rem] lg:text-[0.7rem] text-gray-400 mt-1 font-medium" x-text="activeStep === 1 ? 'Menyimpan transkripsi...' : (session.raw_transcription !== '-' ? 'Selesai' : 'Menunggu antrean')"></p>
        </div>
    </div>
    ...
    <div class="relative flex items-start gap-3 lg:gap-4 group">
        <div class="relative z-10">
            <div class="w-10 h-10 lg:w-12 lg:h-12 rounded-full flex items-center justify-center transition-all duration-500 shadow-lg border-4 border-white"
                ...
                <i data-lucide="wand-2" class="w-4 h-4 lg:w-5 lg:h-5"></i>
            </div>
        </div>
        <div class="flex-1 pt-0.5 lg:pt-1">
            <h4 class="text-[0.7rem] lg:text-xs font-black uppercase tracking-widest"
            ...
            <p class="text-[0.65rem] lg:text-[0.7rem] text-gray-400 mt-1 font-medium" x-text="activeStep === 2 ? 'Merapikan teks...' : (session.refined_transcription !== '-' ? 'Selesai' : 'Menunggu antrean')"></p>
        </div>
    </div>
    ...
    <div class="relative flex items-start gap-3 lg:gap-4 group">
        <div class="relative z-10">
            <div class="w-10 h-10 lg:w-12 lg:h-12 rounded-full flex items-center justify-center transition-all duration-500 shadow-lg border-4 border-white"
                ...
                <i data-lucide="git-compare" class="w-4 h-4 lg:w-5 lg:h-5"></i>
            </div>
        </div>
        <div class="flex-1 pt-0.5 lg:pt-1">
            <h4 class="text-[0.7rem] lg:text-xs font-black uppercase tracking-widest"
            ...
            <p class="text-[0.65rem] lg:text-[0.7rem] text-gray-400 mt-1 font-medium" x-text="activeStep === 3 ? 'Sinkronisasi teks...' : (session.matched_transcription !== '-' ? 'Selesai' : 'Menunggu antrean')"></p>
        </div>
    </div>
    ...
    <div class="relative flex items-start gap-3 lg:gap-4 group">
        ...
        <div class="flex-1 pt-0.5 lg:pt-1">
            ...
            <p class="text-[0.65rem] lg:text-[0.7rem] text-gray-400 mt-1 font-medium" x-text="activeStep === 4 ? 'Klasifikasi advice...' : (session.advice_category !== '-' ? 'Selesai' : 'Menunggu antrean')"></p>
        </div>
    </div>
    ...
    <div class="relative flex items-start gap-3 lg:gap-4 group">
        ...
        <div class="flex-1 pt-0.5 lg:pt-1">
            ...
            <p class="text-[0.65rem] lg:text-[0.7rem] text-gray-400 mt-1 font-medium" x-text="activeStep === 5 ? 'Analisis relasi...' : (session.character_category !== '-' ? 'Selesai' : 'Menunggu antrean')"></p>
        </div>
    </div>
    ...
    <div class="relative flex items-start gap-3 lg:gap-4 group">
        ...
        <div class="flex-1 pt-0.5 lg:pt-1">
            ...
            <p class="text-[0.65rem] lg:text-[0.7rem] text-gray-400 mt-1 font-medium" x-text="activeStep === 6 ? 'Laporan akhir...' : (session.intonation_analysis !== '-' ? 'Selesai' : 'Menunggu antrean')"></p>
        </div>
    </div>
</div>
