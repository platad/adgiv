...
document.addEventListener('alpine:init', () => {
    Alpine.data('chatApp', (sessionId, sessionTitle) => ({
        ...
        async init() {
            console.log("[Supervisory AI] Component Initialized", this.sessionId);
            try {
        ...
        async handleMultiStepAnalysis(text) {
            ...
            try {
                ...
                console.log("[Supervisory AI] Step 1: Saving Transcription Starting...");
                this.activeStep = 1;
                ...
                console.log("[Supervisory AI] Step 1 Finished", data1);
                this.session.raw_transcription = text;

                console.log("[Supervisory AI] Step 2: Refine Starting...");
                this.activeStep = 2;
                ...
                console.log("[Supervisory AI] Step 2 Finished", data2);
                if (data2.data) this.session.refined_transcription = data2.data.refined_text;

                // Step 3: Matching
                console.log("[Supervisory AI] Step 3: Matching Starting...");
                this.activeStep = 3;
                ...
                console.log("[Supervisory AI] Step 3 Finished", data3);
                if (data3.data) this.session.matched_transcription = data3.data.matched_text;

                // Step 4: Advice
                console.log("[Supervisory AI] Step 4: Advice Starting...");
                this.activeStep = 4;
                ...
                console.log("[Supervisory AI] Step 4 Finished", data4);
                if (data4.data) this.session.advice_category = data4.data.category;

                // Step 5: Character
                console.log("[Supervisory AI] Step 5: Character Starting...");
                this.activeStep = 5;
                ...
                console.log("[Supervisory AI] Step 5 Finished", data5);
                if (data5.data) this.session.character_category = data5.data.category;

                // Step 6: Final
                console.log("[Supervisory AI] Step 6: Insights Starting...");
                this.activeStep = 6;
                ...
                console.log("[Supervisory AI] Step 6 Finished", data6);
                ...
                if (data6.full_message) {
                    console.log("[Supervisory AI] Workflow Complete. Streaming result...");
