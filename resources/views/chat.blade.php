<x-layouts.app :activeSessionId="$activeSession->id">
    ...
    <div class="flex-1 flex flex-col w-full bg-gray-50/30"
        ...
        {{-- ── Top: Input Section ── --}}
        <div class="shrink-0 bg-white border-b border-gray-100 p-8 shadow-sm z-10">
            <div class="w-full">
                <div class="flex items-center gap-4 mb-6">
                    <div class="w-12 h-12 bg-bima-red rounded-2xl flex items-center justify-center text-white shadow-lg">
                        <i data-lucide="mic-2" class="w-6 h-6"></i>
                    </div>
                    <div>
                        <h2 class="text-2xl font-black text-gray-900 tracking-tight">Mulai Analisis Bimbingan</h2>
                        <p class="text-sm text-gray-500 font-medium italic">Rekam atau unggah audio untuk memulai workflow BIMA AI</p>
                    </div>
                </div>
                
                <div class="bg-white rounded-[2rem] shadow-2xl shadow-red-100/50 border border-red-50 p-2">
                    <x-voice-input />
                </div>
            </div>
        </div>
                ...
                <div class="lg:col-span-2 flex flex-col gap-6">
                    <div class="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm relative overflow-hidden min-h-[500px]">
                        <div class="absolute top-0 right-0 p-10 opacity-[0.03] pointer-events-none">
                            <i data-lucide="brain-circuit" class="w-64 h-64 text-bima-red"></i>
                        </div>
