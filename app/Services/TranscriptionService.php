...
class TranscriptionService
{
    ...
    {
        Log::info('[TranscriptionService] Audio received for Groq.', [
        ...
        if (!$apiKey) {
            return "[SISTEM: API Key Groq tidak ditemukan.]";
        }
        ...
        try {
            ...
            Log::error('[TranscriptionService] Groq Error: ' . $e->getMessage());
            return "[SISTEM: Gagal transkripsi via Groq. Error: " . $e->getMessage() . "]";
        }
    }
